...
var promptAgean = require("prompt-sync")();
...
mongo.connect(url, function(err, db){
  ...
  console.log("Type the number of a resturant and press enter to display it's info or create a new entry by typing 'new': ")
